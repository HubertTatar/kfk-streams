...
import io.huta.common.{AdminConnectionProps, JsonDeserializer, JsonSerializer, Logging}
...
object StreamToStreamOuterJoin extends AdminConnectionProps with Logging {
